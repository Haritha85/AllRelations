...
router.get("/details", function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    userRepo = datasource_1.default.getRepository(user_1_entity_1.user_1);
...
router.post("/create", function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, firstName, lastName, isActive, profile_1, newUser, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    _a = req.body, firstName = _a.firstName, lastName = _a.lastName, isActive = _a.isActive, profile_1 = _a.profile;
                    ...
                    return [4 /*yield*/, service_1.default.createUser(firstName, lastName, isActive, profile_1.age, profile_1.gender, profile_1.skill)];
                case 1:
                    newUser = _b.sent();
                    res.json(newUser);
                    return [3 /*break*/, 3];
